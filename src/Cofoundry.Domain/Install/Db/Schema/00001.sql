...
create table if not exists Cofoundry.AutoUpdateLock (
...
create table if not exists Cofoundry.ModuleUpdate (
...
create table if not exists Cofoundry.ModuleUpdateError (
...
create table if not exists Cofoundry.Locale (
...
create table if not exists Cofoundry.UserArea (
...
create table if not exists Cofoundry.Role(
...
create table if not exists Cofoundry.User (
...
create table if not exists Cofoundry.EntityDefinition (
...
create table if not exists Cofoundry.CustomEntityDefinition (
...
create table if not exists Cofoundry.Tag (
...
create table if not exists Cofoundry.WebDirectory (
...
create table if not exists Cofoundry.WebDirectoryLocale (
...
create table if not exists Cofoundry.WorkFlowStatus (
...
create table if not exists Cofoundry.DocumentAsset (
...
create table if not exists Cofoundry.DocumentAssetGroup (
...
create table if not exists Cofoundry.DocumentAssetGroupItem (
...
create table if not exists Cofoundry.DocumentAssetTag (
...
create table if not exists Cofoundry.FailedAuthenticationAttempt (
...
create table if not exists Cofoundry.ImageCropAnchorLocation(
...
create table if not exists Cofoundry.ImageAsset (
...
create table if not exists Cofoundry.ImageAssetGroup (
...
create table if not exists Cofoundry.ImageAssetGroupItem (
...
create table if not exists Cofoundry.ImageAssetTag (
...
create table if not exists Cofoundry.PageType (
...
create unique index UIX_Page_Path on Cofoundry.Page (WebDirectoryId, LocaleId, UrlPath);



/****** Cofoundry.PageGroup ******/

create table if not exists Cofoundry.PageGroup (

	PageGroupId int not null AUTO_INCREMENT,
	GroupName nvarchar(64) not null,
...
create table if not exists Cofoundry.PageGroupItem (
...
create table if not exists Cofoundry.PageModuleType (

	PageModuleTypeId int not null AUTO_INCREMENT,
	Name nvarchar(32) not null,
	Description text not null,
...
create table if not exists Cofoundry.PageModuleTypeTemplate (

	PageModuleTypeTemplateId int  not null AUTO_INCREMENT,
...
create table if not exists Cofoundry.PageTag (
...
create table if not exists Cofoundry.PageTemplate (
...
create table if not exists Cofoundry.PageTemplateSection (

	PageTemplateSectionId int not null AUTO_INCREMENT,
...
create table if not exists Cofoundry.PageTemplateSectionPageModuleType (
...
create table if not exists Cofoundry.PageVersion (

	PageVersionId int not null AUTO_INCREMENT,
	PageId int not null,
	PageTemplateId int not null,
	...
	CreateDate datetime not null,
	CreatorId int not null,
	ExcludeFromSitemap bit not null default (0),
	OpenGraphTitle nvarchar(64) null,
	OpenGraphDescription text null,
...
create unique index UIX_PageVersion_DraftVersion on Cofoundry.PageVersion (PageId);
create unique index UIX_PageVersion_PublishedVersion on Cofoundry.PageVersion (PageId);


/****** Cofoundry.PageVersionModule ******/

create table if not exists Cofoundry.PageVersionModule (

	PageVersionModuleId int AUTO_INCREMENT not null,
...
create table if not exists Cofoundry.CustomEntity (

	CustomEntityId int AUTO_INCREMENT not null,
	CustomEntityDefinitionCode char(6) not null,
	LocaleId int null,
...
create table if not exists Cofoundry.CustomEntityVersion (

	CustomEntityVersionId int AUTO_INCREMENT not null,
...
create unique index UIX_CustomEntityVersion_DraftVersion on Cofoundry.CustomEntityVersion (CustomEntityId) ;
create unique index UIX_CustomEntityVersion_PublishedVersion on Cofoundry.CustomEntityVersion (CustomEntityId) ;


/****** Cofoundry.CustomEntityVersionPageModule ******/

create table if not exists Cofoundry.CustomEntityVersionPageModule (

	CustomEntityVersionPageModuleId int AUTO_INCREMENT not null,
...
create table if not exists Cofoundry.Permission (
...
create table if not exists Cofoundry.RolePermission (
...
create table if not exists Cofoundry.RelatedEntityCascadeAction (
...
create table if not exists Cofoundry.RewriteRule (

	RewriteRuleId int AUTO_INCREMENT not null,
...
create table if not exists Cofoundry.Setting (
...
create table if not exists Cofoundry.UnstructuredDataDependency (
...
create table if not exists Cofoundry.UserLoginLog (

	UserId int not null,
	IPAddress varchar(45) not null,
	LoginDate datetime not null,
	UserLoginLogId int AUTO_INCREMENT not null,
...
create table if not exists Cofoundry.UserPasswordResetRequest (

	UserPasswordResetRequestId varchar(38) not null,
	UserId int not null,
	Token text not null,
	CreateDate datetime not null,
...
insert Cofoundry.PageModuleType (Name, Description, FileName, IsCustom, CreateDate) values (N'Plain text', N'A simple module when you want just a bit of text. Consider using rich text or raw html if you need more control over the rendering', N'PlainText', 0, Now());

insert Cofoundry.PageModuleType (Name, Description, FileName, IsCustom, CreateDate) values (N'Image', N'', N'Image', 0, Now());
insert Cofoundry.PageModuleType (Name, Description, FileName, IsCustom, CreateDate) values (N'Single line of text', N'A single line of text, no formatting', N'SingleLineText', 0, Now());
insert Cofoundry.PageModuleType (Name, Description, FileName, IsCustom, CreateDate) values (N'Quotation', N'Quotation with optional citation and title', N'Quotation', 0, Now());
insert Cofoundry.PageModuleType (Name, Description, FileName, IsCustom, CreateDate) values (N'Text list', N'Text list items', N'TextList', 0, Now());
insert Cofoundry.PageModuleType (Name, Description, FileName, IsCustom, CreateDate) values (N'Raw html', N'Raw html', N'RawHtml', 0, Now());
insert Cofoundry.PageModuleType (Name, Description, FileName, IsCustom, CreateDate) values (N'Document download', N'Download a document asset', N'Document', 0, Now());
insert Cofoundry.PageModuleType (Name, Description, FileName, IsCustom, CreateDate) values (N'Horizontal line', N'Horizontal line', N'HorizontalLine', 0, Now());
insert Cofoundry.PageModuleType (Name, Description, FileName, IsCustom, CreateDate) values (N'YouTube video', N'Embed a YouTube video', N'YoutubeVideo', 0, Now());
insert Cofoundry.PageModuleType (Name, Description, FileName, IsCustom, CreateDate) values (N'Vimeo video', N'Embed a Vimeo video', N'VimeoVideo', 0, Now());
insert Cofoundry.PageModuleType (Name, Description, FileName, IsCustom, CreateDate) values (N'Rich Text', N'Text entry with simple formatting like headings and lists.', N'RichText', 0, Now());
insert Cofoundry.PageModuleType (Name, Description, FileName, IsCustom, CreateDate) values (N'RichTextWithMedia', N'Text entry with simple formatting and image/video media functionality.', N'RichTextWithMedia', 0, Now());
...
insert Cofoundry.Setting (SettingKey, SettingValue, CreateDate, UpdateDate) values ('ApplicationName', N'"Cofoundry"', Now(), Now());
insert Cofoundry.Setting (SettingKey, SettingValue, CreateDate, UpdateDate) values ('RobotsTxt', N'"User-agent: *"', Now(), Now());
insert Cofoundry.Setting (SettingKey, SettingValue, CreateDate, UpdateDate) values ('HumansTxt', N'""', Now(), Now());
insert Cofoundry.Setting (SettingKey, SettingValue, CreateDate, UpdateDate) values ('GoogleAnalyticsUAId', N'""', Now(), Now());
insert Cofoundry.Setting (SettingKey, SettingValue, CreateDate, UpdateDate) values ('IsSetup', N'false', Now(), Now());
